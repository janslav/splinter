...
namespace Splinter.Phase2_Mutation.NinjaTurtles
{
    ...
    /// </summary>
    public class MutatedAssembly
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MutatedAssembly" /> class.
        /// </summary>
        /// <param name="assemblyLocation">
        /// The location on disk of the assembly whose main module is to be
        /// loaded.
        /// </param>
        public MutatedAssembly(FileInfo assemblyLocation)
        {
        ...
        /// </summary>
        public ModuleDefinition Definition { get { return this.AssemblyDefinition.MainModule; } }
        ...
        //    {
        //        symbolLocation = AssemblyLocation.FullName;
